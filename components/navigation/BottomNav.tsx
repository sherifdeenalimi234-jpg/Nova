...
const BottomNav: React.FC<BottomNavProps> = ({ activeTab, setActiveTab, isCreator = false }) => {
  ...
  const moreItems = [
    ...
    ...(isCreator ? [
      ...
      { label: "Survey Dashboard", icon: BarChart3, href: "/survey/dashboard" },
      { label: "Survey Manage", icon: ClipboardList, href: "/survey/manage" },
    ] : []),
    { label: "Explore Nodes", icon: LayoutGrid, href: "/projects/explore" },
    { label: "Discover Surveys", icon: ClipboardList, href: "/survey/discover" },
