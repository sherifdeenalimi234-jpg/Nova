    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-screen p-6 text-center bg-[#050505] text-white">
          ...
          <h2 className="text-2xl font-black uppercase tracking-tighter mb-4">Workspace Error</h2>
          <p className="text-white/40 text-xs mb-8 uppercase tracking-widest">We encountered an issue loading this research module</p>
          ...
          <div className="max-w-2xl w-full bg-white/[0.02] border border-white/5 rounded-3xl p-6 mb-8 text-left overflow-hidden">
             ...
             <div className="font-mono text-[11px] text-white/40 space-y-2 break-all">
                <p className="text-white/80 font-bold">{this.state.error?.toString() || "Unknown Research Protocol Error"}</p>
                <div className="h-px bg-white/5 my-2" />
                <p className="text-[9px] opacity-20 leading-relaxed whitespace-pre-wrap">
