...
import DeleteSurveyModal from '@/components/creator/DeleteSurveyModal';
         ...
         {loading ? (
           ...
           <div className="flex flex-col items-center justify-center py-24 text-center p-8 rounded-[3rem] border border-dashed border-white/10 bg-white/[0.01]">
              ...
              {!searchQuery && statusFilter === 'all' && (
                <Link href="/creator/surveys/new" className="px-8 py-4 rounded-2xl bg-white text-black text-[10px] font-black uppercase tracking-widest hover:bg-nova-cyan transition-all">
                   Design First Survey
                </Link>
              )}
           </div>
